...
const [activeNav , setActiveNav] = useState("#")
  ...
  return (
    <div id="floatnav">
      ...
      <a href="#techstack" onClick={()=>setActiveNav('#techstack')} className={activeNav === '#techstack' ?'active': ''}><GoBookmark/></a>
      <a href="#Project" onClick={()=>setActiveNav('#Project')} className={activeNav === '#Project' ?'active': ''}><GoProject/></a>
      <a href="#state" onClick={()=>setActiveNav('#state')} className={activeNav === '#state' ?'active': ''}><FaLaptopCode/></a>
