...
import AboutImage from "../../assest/rohit.png";
import "./About.css";
  ...
  return (
    <section id="about">
      ...
      <div className="about_conatiner">
        <div className="photo">
          <img src={AboutImage} alt="rohit" class="img-fluid" />
        </div>
        <div>
          <div>
            ...
            <p>
              ...
              something new and deal with new tasks and challenges. I have done
              my Bechlor's of Engineering from Greater Noida , Uttar Pradesh ,
              India.
            </p>
          </div>
          <br />
          ...
          <div>
            <p>
              ...
              Algorithms , ⏰100+ Hours Math & Logic , 📂10+ Projects &
              Hackathon
            </p>
          </div>
          <br />
          <div>
            <a
              href="https://drive.google.com/file/d/1hxLGeMjpYT4OVOPhf82WxHYoeNb5FBkD/view?usp=share_link"
              target="_blank"
              download
